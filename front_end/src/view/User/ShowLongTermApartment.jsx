...
function ShowLongTermApartment() {
  ...
  const fetchLongTermApartments = () => {
    ...
    axios
      ...
      .then((response) => {
        const longTermApartments = response.data.filter((apartment) => apartment.type_room === 'Phòng dài hạn');
...
export default ShowLongTermApartment;
