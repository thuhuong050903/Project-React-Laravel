...
className="artboard-11-150x150-1-1-icon"
      ...
      <div className="navigation">
        ...
        <button onClick={nextSlide}>Next</button>
          ...
          <div className="jinjoo-home-scholarship-container">
            <p className="nu-co-working-l">{`JinJoo Home Scholarship – Accommodation & Career, `}</p>
            <p className="nu-co-working-l">mentorship Scholarship</p>
          </div>
          <div className="co-living-space">
            Co-living Space – Luồng Gió Mới Cho GenZ Việt Nam
          </div>
          <div className="top-qun-cafe-container">
            <p className="nu-co-working-l">Top Quán Cafe Acoustic Quận 3</p>
