...
var me = "style[".concat(f, "][").concat("data-styled-version", '="').concat("6.0.0", '"]');
...
var we = function(e2) {
  var t2 = document.head, n = e2 || t2, o2 = document.createElement("style"), r3 = function(e3) {
    return Array.from(e3.querySelectorAll("style[".concat(f, "]"))).at(-1);
  }(n), s3 = void 0 !== r3 ? r3.nextSibling : null;
  o2.setAttribute(f, "active"), o2.setAttribute("data-styled-version", "6.0.0");
  var i3 = Se();
...
function Ge(e2, t2, n, o2) {
  ...
  var s3;
  return e2 instanceof Fe ? n ? (e2.inject(n, o2), [e2.getName(o2)]) : [e2] : oe(e2) ? Le(e2) : Array.isArray(e2) ? e2.flatMap(function(e3) {
...
function Qe(e2, r3, s3) {
  var i3 = ee(e2), a2 = e2, c3 = !M(e2), p3 = r3.attrs, d2 = void 0 === p3 ? E : p3, h2 = r3.componentId, f3 = void 0 === h2 ? function(e3, t2) {
    ...
    Ze[n] = (Ze[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(x("6.0.0" + n + Ze[n]));
  ...
  var I3 = new qe(s3, v3, i3 ? a2.componentStyle : void 0), O3 = I3.isStatic && 0 === d2.length;
  function D3(e3, r4) {
    return function(e4, r5, s4, i4) {
      var a3 = e4.attrs, c4 = e4.componentStyle, p4 = e4.defaultProps, d3 = e4.foldedComponentIds, h3 = e4.styledComponentId, f4 = e4.target, m3 = import_react.default.useContext(He), y4 = Ve(), v4 = e4.shouldForwardProp || y4.shouldForwardProp;
      (0, import_react.useDebugValue)(h3);
      var g3 = function(e5, n, o2) {
      ...
      }(a3, r5, P(r5, m3, p4) || N), S4 = g3.as || f4, w4 = {};
      for (var b3 in g3)
        void 0 === g3[b3] || "$" === b3[0] || "as" === b3 || "theme" === b3 || ("forwardedAs" === b3 ? w4.as = g3.forwardedAs : v4 && !v4(b3, S4) || (w4[b3] = g3[b3])), v4 || false || isPropValid(b3) || Ke.has(b3) || (Ke.add(b3), console.warn('styled-components: it looks like an unknown prop "'.concat(b3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')));
      ...
      !i4 && e4.warnTooManyClasses && e4.warnTooManyClasses(E3);
      var C4 = te(d3, h3);
      return E3 && (C4 += " " + E3), g3.className && (C4 += " " + g3.className), w4[M(S4) && !_.has(S4) ? "class" : "className"] = C4, w4.ref = s4, (0, import_react.createElement)(S4, w4);
    }(R3, e3, r4, O3);
  }
  D3.displayName = y3;
  var R3 = import_react.default.forwardRef(D3);
  return R3.attrs = g2, R3.componentStyle = I3, R3.displayName = y3, R3.shouldForwardProp = S3, R3.foldedComponentIds = i3 ? te(a2.foldedComponentIds, a2.styledComponentId) : "", R3.styledComponentId = v3, R3.target = i3 ? a2.target : e2, Object.defineProperty(R3, "defaultProps", { get: function() {
  ...
  } }), b(y3, v3), R3.warnTooManyClasses = function(e3, t2) {
    var n = {}, o2 = false;
    return function(r4) {
  ...
  }(y3, v3), se(R3, function() {
    return ".".concat(R3.styledComponentId);
  }), c3 && K(R3, e2, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true }), R3;
}
function et(e2, t2) {
...
var ut = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t2 = e3.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.0.0", '"')].filter(Boolean), " ");
      ...
      if (e3.sealed)
        throw ce(2);
      var r3 = ((n = {})[f] = "", n["data-styled-version"] = "6.0.0", n.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, n), s3 = Se();
