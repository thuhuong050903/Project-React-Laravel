...
function Qe(e2, r3, s3) {
  ...
  function D3(e3, r4) {
    return function(e4, r5, s4, i4) {
      ...
      var E3 = function(e5, t2, n) {
        var o2 = Ve(), r6 = e5.generateAndInjectStyles(t2 ? N : n, o2.styleSheet, o2.stylis);
        return (0, import_react.useDebugValue)(r6), r6;
      }(c4, i4, g3);
...
var ut = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t2 = e3.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.0.0-rc.6", '"')].filter(Boolean), " ");
      ...
      if (e3.sealed)
        throw ce(2);
      var r3 = ((n = {})[f] = "", n["data-styled-version"] = "6.0.0-rc.6", n.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, n), s3 = Se();
